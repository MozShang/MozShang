var nav,leave,header,log,logText,headerRight,user,password,submit,signUp,recordName;
init();
function init() {
...
function getUlWidth() {
    ...
    var width=0;
    for(var i=0;i<len;i++){
        // console.log(nav.firstElementChild.children[i].offsetWidth,width);
        // console.log(nav.firstElementChild.children[i],nav.firstElementChild.children[i].offsetWidth);
        width+=nav.firstElementChild.children[i].offsetWidth;
    }
